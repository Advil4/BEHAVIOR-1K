...
class G1WithInspireHand(ArticulatedTrunkRobot, MobileManipulationRobot):
    """
    G1 Robot
    """
    ...
    def finger_link_names(self):
        return {
                "left": [],
                "right": [  "right_hand_link11", "right_hand_link12", 
                            "right_hand_link13", "right_hand_link14",
                            "right_hand_link21", "right_hand_link22",
                            "right_hand_link31", "right_hand_link32",
                            "right_hand_link41", "right_hand_link42",
                            "right_hand_link51", "right_hand_link52"],
                }
    ...
    def arm_workspace_range(self):
        return {"left": th.deg2rad(th.tensor([-170, 170], dtype=th.float32)), 
                "right": th.deg2rad(th.tensor([-170, 170], dtype=th.float32))}
